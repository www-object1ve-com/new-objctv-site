...
if ( isset( $submenu[ $parent_slug ] ) ) {
	foreach ( $submenu[ $parent_slug ] as $i => $sub_item ) {
		...
		// Flag core tabs.
		$core_tabs_classes = array( 'acf-field-group', 'acf-post-type', 'acf-taxonomy', 'acf-tools', 'acf-settings-updates' );
...
if ( ! in_array( $screen->id, array( 'acf-field-group', 'acf-post-type', 'acf-taxonomy' ) ) ) {
