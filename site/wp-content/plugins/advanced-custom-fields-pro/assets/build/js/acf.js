...
(function ($, undefined) {
  ...
  */
  ...
  acf.show = function ($el, lockKey) {
    ...
    // Ignore acf-dividers.
    if ($el.hasClass('acf-divider')) return;

    // Check if the element has a .acf-divider right before it and hide that too if required.
    if ($el.prev().hasClass('acf-divider acf-hidden')) {
      $el.prev().removeClass('acf-hidden');
    }
  ...
  acf.hide = function ($el, lockKey) {
    ...
    // Check if the element has a .acf-divider right before it and hide that too if required.
    if ($el.prev().hasClass('acf-divider')) {
      $el.prev().addClass('acf-hidden');
    }
